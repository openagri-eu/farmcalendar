# Generated by Django 5.0.4 on 2024-08-14 16:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_id', models.UUIDField(blank=True, verbose_name='Georaphic Data ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('geo_id', models.UUIDField(blank=True, verbose_name='Geographic Data ID')),
                ...
                ('area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)ss', to='harvesthand.farmarea')),
            ],
            options={
