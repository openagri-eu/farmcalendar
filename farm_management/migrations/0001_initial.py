# Generated by Django 5.0.4 on 2024-11-04 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('latitude', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, verbose_name='Latitude')),
                ('longitude', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, verbose_name='Longitude')),
                ('geometry', models.TextField(blank=True, null=True, verbose_name='Geometry (WKT)')),
                ('geo_id', models.CharField(blank=True, null=True, verbose_name='Geographic Data ID')),
