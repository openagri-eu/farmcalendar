# Generated by Django 5.0.4 on 2024-10-29 11:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Unnamed', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('identifier', models.CharField(default='Unnamed', max_length=100, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
                ...
                ('irrigation_flow', models.FloatField(blank=True, null=True)),
                ('geo_id', models.UUIDField(blank=True, null=True, verbose_name='Geographic Data ID')),
                ('coordinates', models.CharField(default='0.0,0.0', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('geometry_type', models.CharField(default='Polygon', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, editable=False, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(blank=True, editable=False, verbose_name='Updated At')),
                ('name', models.CharField(db_index=True, default='Unnamed', max_length=255)),
                ('description', models.TextField(blank=True, null=True)),
                ('administrator', models.CharField(blank=True, max_length=255, null=True)),
                ('contact_person_firstname', models.CharField(blank=True, max_length=255, null=True)),
                ('contact_person_lastname', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, editable=False, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(blank=True, editable=False, verbose_name='Updated At')),
                ('identifier', models.CharField(db_index=True, default='Unnamed', max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
                ('category', models.CharField(choices=[('pasture', 'Pasture'), ('arable', 'Arable'), ('vineyard', 'Vineyard')], default='arable', max_length=50)),
                ('valid_from', models.DateTimeField(blank=True, null=True)),
                ('valid_to', models.DateTimeField(blank=True, null=True)),
